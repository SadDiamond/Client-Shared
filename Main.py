...
class MyWindow(QMainWindow,Ui_client):
    def __init__(self):
        ...
        self.Button_Challenges.clicked.connect(self.showChallengesWindow)
            ...
            for oneCmd in cmdArray:
                ...
                if data=="":
                    ...
                    try:
                        ...
                        print(e)
                elif data[0]==cmd.CMD_CHALLENGE:
                    try:
                        if self.challengeWindow is not None:
                            self.challengeWindow.on_server_message(data)
                    except Exception as e:
                        print(e)
