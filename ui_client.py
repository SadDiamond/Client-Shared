...
"font: 10pt \"Arial\";")
        ...
        self.Button_Challenges = QtWidgets.QPushButton(client)
        self.Button_Challenges.setGeometry(QtCore.QRect(880, 470, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.Button_Challenges.setFont(font)
        self.Button_Challenges.setStyleSheet("font: 10pt \"Arial\";")
        self.Button_Challenges.setObjectName("Button_Challenges")
...
"font: 10pt \"Arial\";")
    ...
    def retranslateUi(self, client):
        ...
        self.Button_Challenges.setText(_translate("client", "Challenges"))
